...
class Contact:
    ...
    def __init__(self, name=None, middlename=None, lastname=None, address=None, email=None, id=None, homephone=None, mobilephone=None, workphone=None, all_phones_from_home_page=None):
        self.name = name
